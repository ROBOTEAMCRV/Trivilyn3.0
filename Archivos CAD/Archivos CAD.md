# 🛠️ Modelado 3D y Componentes CAD: Chasis Trivilyn 3.0

En esta sección se encuentran almacenados todos los archivos de modelado tridimensional (formatos `.STL` y `.STEP`) desarrollados a medida para la estructura modular de **Trivilyn 3.0**.
...
## ⚙️ Parámetros de Fabricación en Impresión 3D
...
## 🗂️ Desglose de Componentes Estructurales
...
* **`Segundo Piso.stl`:** Nivel intermedio del chasis. Aloja los sistemas de control y regulación de voltaje. Integra mecánicamente el **riel macho** para el acople del sistema de visión.
...
* **`Riel Hembra Cola de milano.stl`:** Pieza clave del sistema de calibración física. Desliza sobre el riel macho del segundo piso, permitiendo ajustar de forma milimétrica la posición de la cámara según los requerimientos de la pista.
* **`Espaciadores de elevador.stl`:** Componentes utilizados para calibrar la altura exacta del conjunto de visión, modificando el ángulo de ataque de la cámara para mitigar la zona ciega del suelo.

### Monturas de Percepción 
* **`Base sensor frontal.stl`:** Soporte dedicado para el sensor ultrasónico central, posicionándolo a una altura geométrica de **5.5 cm respecto al suelo** para asegurar la detección del muro de fondo como freno de emergencia.
